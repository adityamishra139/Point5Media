"use client"; // If you're using a framework that supports this directive, like Next.js
  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-green-500 to-green-800 py-4 bg-clip-text text-center text-3xl font-medium tracking-tight text-transparent md:text-5xl">
        Where creativity meets  <br /> innovation in every frame.
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({ children, className }) => {
  return (
    <div className={cn("relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0", className)}>
